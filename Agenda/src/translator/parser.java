...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue May 30 00:51:09 PDT 2017
  */
      ...
      switch (CUP$parser$act_num)
        {
          ...
          case 67: // nt_length ::= 
            {
              Integer RESULT =null;
		RESULT=0; System.out.println("duración?");CUP$parser$parser.report_fatal_error(""+RESULT, this);
		...
		Date d2 = (Date)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                        	...
                        	actionMessage=new ActionMessage(eAction.UPDATE,s,start1,start2,end2);
		...
		Date d = (Date)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                        	...
                        	actionMessage=new ActionMessage(eAction.DELETE,s,start);
                        	System.out.println("CHIDO"); 
		...
		Date d = (Date)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 System.out.println("CHIDO"); 
                        	...
                        	actionMessage=new ActionMessage(eAction.CREATE,s,start,end);
